...
from transformer_encoder import AddNormalization, FeedForward
...
class DecoderLayer(Layer):
    ...
    def call(self, x, encoder_output, lookahead_mask=None, padding_mask=None, training=True):
        ...
        multihead_output2 = self.multihead_attention2(addnorm_output1, encoder_output, encoder_output, mask=padding_mask)
...
# print(decoder(input_seq, enc_output, lookahead_mask=None, padding_mask=None, training=True))