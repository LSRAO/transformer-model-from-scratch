...
from tensorflow import data, train, math, reduce_sum, cast, equal, argmax, float32, GradientTape, function, maximum, int64
from keras.losses import sparse_categorical_crossentropy
from transformer_model import TransformerModel
from prepare_dataset_v2 import PrepareDataset
...
for epoch in range(epochs):
    ...
    if (epoch + 1) % 1 == 0:
        ...
        training_model.save_weights("weights_enger/wghts" + str(epoch + 1) + ".weights.h5")
